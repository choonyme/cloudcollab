...
typedef void (*rfbKbdAddEventProcPtr) (rfbBool down, rfbKeySym keySym, int id, struct _rfbClientRec* cl);
typedef void (*rfbKbdReleaseAllKeysProcPtr) (struct _rfbClientRec* cl);
typedef void (*rfbPtrAddEventProcPtr) (int buttonMask, int x, int y, int id, struct _rfbClientRec* cl);
...
typedef struct _rfbClientRec {
    ...
    /* VNCProxy - add individual pointer callback for each client */
    rfbPtrAddEventProcPtr ptrAddEvent;
    rfbKbdAddEventProcPtr kbdAddEvent;
 ...
 * edited by VNCProxy
 * */
extern void rfbDefaultPtrAddEvent(int buttonMask,int x,int y,int id,rfbClientPtr cl);
